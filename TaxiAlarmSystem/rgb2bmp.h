...
int RGB2BMP(char *rgb_buffer,int nWidth,int nHeight,FILE*fp1) ;		// RGB加上头部信息转换成BMP
int write_data(char *filename,unsigned char *buf,int width,int height) ;	// write data to bmp file (save bmp file)
